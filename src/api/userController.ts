...
import type { User, addUserOptions } from '@/api/type/userControllerType'



export const getLoginUser = async(options?:object) => {
...
export const addUser = (options: addUserOptions) => {
